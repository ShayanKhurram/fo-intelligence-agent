...
_COMPRESS_SYSTEM_TEMPLATE = (
    ...
    "determine the value.\n"
    "- G2.Q1 and G2.Q3 must describe the SAME person and cite the SAME `source_url` "
    "when both are answered: G2.Q1 names the firm's most senior decision-maker "
    "(CEO if there is one, otherwise Managing Partner, Managing Member, Founder, "
    "President, CIO, Managing Director, Principal, Partner, COO, or CFO — in that "
    "priority order), and G2.Q3 reports THAT person's exact title as stated on the "
    "page that named them. Do not pair one person's name with a different person's "
    "title, and do not cite a different page for the title than the one that named "
    "them.\n"
